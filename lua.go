...
func init() {
	...
	lslFrame, err = luaBox.FindString("env.lua")
	if err != nil {
...
func (ll *LuaLoader) SetField(v lua.LValue, key string, field lua.LValue) {
	ll.State.SetField(v, key, field)

}

// BuildEnv ... Create the environment for lua
